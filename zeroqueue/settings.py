...
MIDDLEWARE = [
    ...
    'users.middleware.ForcePasswordResetMiddleware',  # Force password reset
    'users.middleware.LoginRedirectMiddleware',  # Handle login redirects
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'keerthana.mg@supporthive.com')
ADMIN_EMAIL = os.getenv('ADMIN_EMAIL', 'keerthana.mg@supporthive.com')
