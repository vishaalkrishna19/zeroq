...
import styles from './OffBoardingFormHeader.module.css';

const OffBoardingFormHeader = () => {
    ...
    <Box className={styles.container}>
      ...
      <Box className={styles.textSection}>
        ...
        <Text className={styles.subtitle}>
          Define the core details and steps for your offboarding process
        </Text>
      </Box>
...
export default OffBoardingFormHeader;
